...
const Component = () => {
  ...
  const { homeState, persistState } = useSelector(
    (state) => ({
      ...
      >
        <View style={[styles.rightItem, STYLES.fx1]}>
          ...
          <View style={STYLES.row}>
            ...
            <Text style={[styles.infoText, STYLES.ml5]}>
        ...
        <View style={styles.centerItem}>
          <Image
            ...
            style={[styles.weatherIcon, STYLES.mb10]}
            resizeMode="contain"
          />
        ...
        <View style={styles.leftItem}>
          <View style={STYLES.alItCenter}>
            <Text style={[styles.infoText, STYLES.mb5]}>
              {item.temp2m.max}°C
            </Text>
            <ThermometerIcon width="30" height="30" />
            <Text style={[styles.infoText, STYLES.mt5]}>
              {item.temp2m.min}°C
            </Text>
          </View>
        </View>
